...
menu_items = [
"John threatened to cancel her performance.",
"John was a rival performer.",
"John tipped badly and flirted a lot.",
"John discovered Lola’s secret."
];
menu_functions = [
function() {
...
function() {
	with (asset_get_index("Dialogue_Helper_Question")) {
		create_dialogue_box([["Wilber E. Bose", "What is the strongest evidence that connects Lola to John’s death?"]]);
	}
	delete_menu();
},
function() {
