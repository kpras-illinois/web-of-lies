...
"I'm eating as much as I can now to become a butterfly.",
"I ate strawberry.",
...
function() {
	with (asset_get_index("Dialogue_Helper")) {
		create_dialogue_box([["Wilber E. Bose", "That evidence should be solid enough to convict Harry Grub!"]]);
		global.caterpillar_convictable = true;
	}
	delete_menu();
},
function() {
